        ...
        return (
            <div className="w-full py-4 bg-bg_1 text-center font-semibold sticky top-0">
                <div className="flex  justify-between mx-4 md:mx-8">
                    <div className="flex">
                        <h3 className="mr-1 text-xl">Filter by:</h3>
                        <div onClick={onClick} className="flex cursor-pointer">
                            <h4 className="text-xl">{type}</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 self-center mb-1 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
